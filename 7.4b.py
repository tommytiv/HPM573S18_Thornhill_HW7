...
class Calibration:
    ...
    def sample_posterior(self):
        ...
        multiCohort = SurvivalCls.myCohort(
            ids=self._cohortIDs,
        ...
        for cohort_id in self._cohortIDs:
            ...
            mean = multiCohort.get_percentage_over_time(cohort_id)
...
OBS_MEAN_5_YEARS = .50    # estimated mean survival time at 5 years
