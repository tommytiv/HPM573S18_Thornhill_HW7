...
class Cohort:
    ...
    def get_over_time(self):
        ...
        for x in self._survivalTimes:
            if x > THRESHHOLD:
                count_over += 1
        overTime = count_over/len(self._survivalTimes)
        return overTime
...
class MultiCohort:
    ...
    def __init__(self, ids, pop_sizes, mortality_probs):
        ...
        self._sumStat_meanOverTime = None
    ...
    def simulate(self, n_time_steps):
        ...
        for i in range(len(self._ids)):
            ...
            self._overTime.append(cohort.get_over_time())
        ...
        self._sumStat_meanOverTime = Stat.SummaryStat('Mean survival time', self._overTime)
    ...
    def get_over_time2(self):
        return sum(self._overTime)/len(self._overTime)

    def get_over_time3(self):
...
print ("The percentage of patients survived beyond 5 years xxxxx = ",multiCohort.get_over_time2())

# plot the histogram
Fig.graph_histogram(
    data=multiCohort.get_over_time3(),
